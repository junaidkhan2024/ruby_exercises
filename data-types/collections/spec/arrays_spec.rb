...
RSpec.describe 'Arrays' do
  ...
  it 'test 5' do
    ...
    last_element = world_cup.delete_at(-1)
  ...
  it 'test 9' do
    ...
    some_teams = []
    some_teams.push(teams[0])
    some_teams.push(teams[1])
  ...
  it 'test 12' do
    ...
    new_scores = scores.insert(-1,scores.delete_at(0))
    new_scores = scores.insert(-1,scores.delete_at(0))
    ...
    # print scores
    scores = [23, 56, 34, 29, 48]
    new_scores = scores.insert(0, scores.delete_at(-1))
